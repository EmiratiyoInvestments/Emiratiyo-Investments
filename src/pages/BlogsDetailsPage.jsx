...
const BlogDetailPage = () => {
  ...
  const {
    ...
    queryKey: ['blog', slug],
    queryFn: () => client.fetch(SINGLE_BLOG_QUERY, {
      slug
    })
  });
  ...
  if (!blog) {
    return <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/blog" className="text-[#e83f25] font-medium" style={{
          fontFamily: 'var(--font-body)'
        }}>
            Back to Blog
          </Link>
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="flex flex-wrap items-center gap-6 mb-8 pb-8 border-b border-gray-200">
            {blog.author && <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold text-black" style={{
                fontFamily: 'var(--font-body)'
              }}>
                    {blog.author.name}
                  </p>
          ...
          fontFamily: 'var(--font-body)'
            ...
            block: {
              ...
              h1: ({
                children
              }) => <h1 className="text-4xl font-bold text-black mt-10 mb-4" style={{
                fontFamily: 'var(--font-display)'
              }}>
                        {children}
                      </h1>,
              h2: ({
                children
              }) => <h2 className="text-3xl font-bold text-black mt-8 mb-4" style={{
                fontFamily: 'var(--font-display)'
              }}>
                        {children}
                      </h2>,
              h3: ({
                children
              }) => <h3 className="text-2xl font-bold text-black mt-6 mb-3" style={{
                fontFamily: 'var(--font-display)'
              }}>
                        {children}
                      </h3>,
            ...
            types: {
              image: ({
                value
                        ...
                        {value.caption && <p className="text-center text-sm text-gray-400 mt-2">
                            {value.caption}
                          </p>}
                      </div>
            },
            marks: {
              link: ({
                children,
                value
              }) => <a href={value.href} target="_blank" rel="noopener noreferrer" className="text-[#e83f25] underline hover:opacity-80">
                        {children}
                      </a>,
              strong: ({
                children
          ...
          {blog.author?.bio && <div className="mt-10 p-8 bg-[#f7f7f7] rounded-2xl">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <p className="font-bold text-black text-lg" style={{
                fontFamily: 'var(--font-display)'
              }}>
                    {blog.author.name}
                  </p>
                  <p className="text-sm text-[#e83f25]" style={{
                fontFamily: 'var(--font-body)'
              }}>
                    {blog.author.role}
                  </p>
