  ...
  return <div className="bg-white min-h-screen">
            <main>                <section className="bg-white pt-32 pb-24 px-6 text-center">
                    <div className="max-w-4xl mx-auto">
                        <p className="text-[#e83f25] text-sm font-bold uppercase tracking-[0.2em] mb-4" style={{
            fontFamily: 'var(--font-body)'
          }}>
                            SERVICES
                        </p>
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-black  sm:mb-2 md:mb-4 leading-tight" style={{
            fontFamily: 'var(--font-display)'
          }}>
                            Our Expertise at Your Service
                        </h1>
                        <p className="text-lg text-[#939393] max-w-2xl mx-auto leading-relaxed" style={{
            fontFamily: 'var(--font-body)'
          }}>
                    ...
                    <div className="max-w-7xl mx-auto">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {services.map((service, index) => <div key={index} className="group relative bg-[#f7f7f7] p-10 rounded-xl transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 hover:bg-white border-b-4 border-transparent hover:border-[#e83f25] flex flex-col h-full">
                                    <h3 className="text-2xl font-bold text-black mb-1 leading-tight transition-colors group-hover:text-[#e83f25]" style={{
                fontFamily: 'var(--font-display)'
              }}>
                                        {service.title}
                                    </h3>
                                    {service.subtitle && <p className="text-sm font-semibold text-[#939393] mb-4 italic" style={{
                fontFamily: 'var(--font-body)'
              }}>
                                            {service.subtitle}
                                        </p>}
                                    <p className="text-[#939393] leading-relaxed mt-4 flex-grow" style={{
                fontFamily: 'var(--font-body)'
              }}>
                                        {service.description}
                                    </p>                                    <div className="mt-8">
              ...
              fontFamily: 'var(--font-display)'
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                            {whyChooseItems.map((item, index) => <div key={index} className="flex flex-col">
                                    <h4 className="text-[#e83f25] font-bold text-xl mb-4" style={{
                fontFamily: 'var(--font-display)'
              }}>
                                        {item.title}
                                    </h4>
                                    <p className="text-[#939393] text-sm leading-relaxed" style={{
                fontFamily: 'var(--font-body)'
              }}>
                                        {item.description}
                                    </p>
