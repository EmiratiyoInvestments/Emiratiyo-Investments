          ...
          backgroundImage: 'url("/images/real estate.jpg")'
            ...
            fontFamily: "var(--font-body)"
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 mb-10">
                            {[{
              icon: TrendingUp,
              text: "Income-generating rental assets"
            }, {
              icon: Target,
              text: "Strategic off-plan entries"
            }, {
              icon: BarChart3,
              text: "Portfolio diversification"
            }, {
              icon: Briefcase,
              text: "Exit-driven planning"
            }, {
              icon: Shield,
              text: "Risk-managed growth"
            }].map((item, idx) => <div key={idx} className="flex items-center gap-4 bg-[#f7f7f7] rounded-xl p-4 sm:p-5 transition-all duration-300 hover:bg-white hover:shadow-lg hover:-translate-y-1 border border-transparent hover:border-[#e83f25]/20 group">
            ...
            fontFamily: "var(--font-body)"
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5 mb-10">
                            {["Property sourcing and acquisition", "Rental strategy and yield optimization", "Tenant placement coordination", "Exit timing and resale strategy", "Fractional ownership structuring", "Investor reporting and performance tracking"].map((service, idx) => <div key={idx} className="flex items-start gap-4">
            ...
            }].map((client, idx) => <div key={idx} className="bg-[#f7f7f7] rounded-xl p-6 sm:p-8 hover:shadow-lg transition-shadow duration-300">
            ...
            }].map((principle, idx) => <div key={idx} className="border border-white/10 rounded-xl p-6 sm:p-8 hover:border-[#e83f25]/50 transition-colors duration-300">
                                    <span style={{
                fontFamily: "var(--font-display)"
            ...
            }].map((authority, idx) => <div key={idx} className="flex items-center gap-4 bg-[#f7f7f7] rounded-xl p-5 sm:p-6 transition-all duration-300 hover:bg-white hover:shadow-lg hover:-translate-y-1 border border-transparent hover:border-[#e83f25]/20 group">
            ...
            fontFamily: "var(--font-body)"
              ...
              fontFamily: "var(--font-body)"
                            ...
                            <div className="flex flex-wrap justify-center gap-3 sm:gap-4">
                                {["No hype.", "No emotional selling.", "No short-term thinking.", "Just strategy."].map((line, idx) => <span key={idx} style={{
                fontFamily: "var(--font-body)"
              }} className={`px-5 sm:px-6 py-2.5 sm:py-3 rounded-full text-sm sm:text-base font-bold ${idx === 3 ? "bg-[#e83f25] text-white" : "bg-[#f7f7f7] text-[#000000]"}`}>
                                        {line}
                                    </span>)}
                            </div>
                        </div>
