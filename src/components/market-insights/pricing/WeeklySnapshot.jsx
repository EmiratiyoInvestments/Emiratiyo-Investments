...
const ChangeBadge = ({
  ...
  return <span style={{
    ...
    color: isZero ? "#64748b" : isUp ? "#15803d" : "#dc2626"
      ...
      {isUp ? <TrendingUp size={11} /> : isZero ? <Minus size={11} /> : <TrendingDown size={11} />}
      {pct > 0 ? "+" : ""}
    ...
    fontSize: 13
      ...
      <thead>
        ...
        background: "#f8fafc"
          ...
          {["#", "Project", "Volume", "Value (AED)"].map((h, i) => <th key={h} style={{
          padding: "8px 14px",
...
const TABS = [{
  key: "offPlanApartments",
  label: "Off-Plan Apts",
  icon: Building2
}, {
  key: "offPlanVillas",
  label: "Off-Plan Villas",
  icon: Home
}, {
  key: "readyApartments",
  label: "Ready Apts",
  ...
  if (isError || !reports?.length) {
    return <div style={{
      ...
      fontFamily: "var(--font-body)"
        ...
        fontWeight: 700,
        marginBottom: 8
      }}>No weekly reports yet</p>
        <p style={{
        fontSize: 13
      }}>Add a Market Report in Sanity Studio to see data here.</p>
      </div>;
  }
    ...
    fontFamily: "var(--font-body)"
          ...
          marginBottom: 16
            ...
            left: 0
              ...
              fill: "#94a3b8"
                ...
                <Line type="monotone" dataKey="value" stroke="#e83f25" strokeWidth={2.5} dot={{
              r: 3,
              fill: "#e83f25"
            }} activeDot={{
              r: 5
          ...
          marginBottom: 16
            ...
            left: 0
              ...
              fill: "#94a3b8"
                ...
                <Line type="monotone" dataKey="volume" stroke="#3b82f6" strokeWidth={2.5} dot={{
              r: 3,
              fill: "#3b82f6"
            }} activeDot={{
              r: 5
      ...
      overflow: "hidden"
        ...
        scrollbarWidth: "none"
          ...
          return <button key={tab.key} onClick={() => setActiveTab(tab.key)} style={{
            padding: "10px 16px",
            fontSize: 12,
            fontWeight: 700,
            border: "none",
