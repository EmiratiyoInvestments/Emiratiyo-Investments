...
const PROPERTIES = [
  {
    ...
    "tags": [],
    "imageUrls": [
      "https://images.bayut.com/thumbnails/831350672-800x600.jpeg",
      "https://images.bayut.com/thumbnails/831350673-800x600.jpeg",
      "https://images.bayut.com/thumbnails/831350674-800x600.jpeg",
      "https://images.bayut.com/thumbnails/831350675-800x600.jpeg",
      "https://images.bayut.com/thumbnails/831350676-800x600.jpeg",
      "https://images.bayut.com/thumbnails/831350677-800x600.jpeg",
      "https://images.bayut.com/thumbnails/831350678-800x600.jpeg",
      "https://images.bayut.com/thumbnails/831350679-800x600.jpeg",
      "https://images.bayut.com/thumbnails/831350680-800x600.jpeg",
      "https://images.bayut.com/thumbnails/831350681-800x600.jpeg",
      "https://images.bayut.com/thumbnails/831350682-800x600.jpeg",
      "https://images.bayut.com/thumbnails/831350683-800x600.jpeg",
      "https://images.bayut.com/thumbnails/831350684-800x600.jpeg",
      "https://images.bayut.com/thumbnails/831350685-800x600.jpeg",
      "https://images.bayut.com/thumbnails/831350686-800x600.jpeg",
      "https://images.bayut.com/thumbnails/831350687-800x600.jpeg",
      "https://images.bayut.com/thumbnails/831350688-800x600.jpeg",
      "https://images.bayut.com/thumbnails/831350689-800x600.jpeg"
    ],
    "featured": false,
    "handoverDate": null
  },
...
async function pushProperty(property, index) {
  ...
  // Clean excerpt
  let cleanExcerpt = (property.excerpt || '')
    .replace(/\s*\|\s*/g, ', ')
    .replace(/Contact.*$/gi, '')
    .trim();
  ...
  // Split by section headings including **Title**
  ...
  for (let i = 0; i < sections.length; i++) {
    ...
    // Check if it's a heading (standard or **Title**)
    ...
    // Split content by bullet separators (space-dash-space or newlines)
    const items = part
      .split(/\n/)
      .map(item => item.trim())
    ...
    items.forEach(item => {
      // Clean up item (handle bullet points)
